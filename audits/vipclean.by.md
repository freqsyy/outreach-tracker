# Отчёт по тестированию сайта vipclean.by

**Дата:** 11.07.2026
**Проверял:** Назар (ручное тестирование)
**Платформа сайта:** Tilda / самопис / WordPress
**Контакт владельца:** info@vipclean.by
...
| 4 | Network (ресурс сайта) | Запрос вернул 404 (Image) на домене сайта. Битый ресурс/роут. | — | MEDIUM |
...
## 4. Итог
Найдено 4 багов. Топ-приоритет: Console / DevTools; Console / DevTools; Console / DevTools
...
- 4. **[MEDIUM]** Network (ресурс сайта): Запрос вернул 404 (Image) на домене сайта. Битый ресурс/роут.
