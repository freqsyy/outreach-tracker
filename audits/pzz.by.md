...
| 2 | Network (ресурс сайта) | Запрос вернул 401 (XHR) на домене сайта. Битый ресурс/роут. | — | MEDIUM |
...
## 4. Итог
Найдено 2 багов. Топ-приоритет: Console / DevTools; Network (ресурс сайта)
...
- 2. **[MEDIUM]** Network (ресурс сайта): Запрос вернул 401 (XHR) на домене сайта. Битый ресурс/роут.
