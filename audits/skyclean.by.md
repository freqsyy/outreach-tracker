# Отчёт по тестированию сайта skyclean.by

**Дата:** 11.07.2026
**Проверял:** Назар (ручное тестирование)
**Платформа сайта:** Tilda / самопис / WordPress
**Контакт владельца:** info@skyclean.by
...
|---|-----|----------|----------|-------------|
| 1 | мобильная вёрстка (375px) | Горизонтальный переполнение на телефоне: scrollWidth=368 > clientWidth=360 (на 8px). Контент уезжает за экран. | — | MEDIUM |
...
- Всего багов: 4
- 1. **[MEDIUM]** мобильная вёрстка (375px): Горизонтальный переполнение на телефоне: scrollWidth=368 > clientWidth=360 (на 8px). Контент уезжает за экран.
