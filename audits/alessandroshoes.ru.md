# Отчёт по тестированию сайта alessandroshoes.ru

**Дата:** 18.07.2026
**Проверял:** Назар (ручное тестирование)
**Платформа сайта:** Tilda / самопис / WordPress
**Контакт владельца:** sales@alessandroshoes.ru
...
|---|-----|----------|----------|-------------|
| 1 | Network (ресурс сайта) | Запрос вернул 404 (Image) на домене сайта. Битый ресурс/роут. | — | MEDIUM |
...
## 4. Итог
Найдено 1 багов. Топ-приоритет: Network (ресурс сайта)
...
- Всего багов: 1
- 1. **[MEDIUM]** Network (ресурс сайта): Запрос вернул 404 (Image) на домене сайта. Битый ресурс/роут.
