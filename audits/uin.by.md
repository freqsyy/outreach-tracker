...
|---|-----|----------|----------|-------------|
| 1 | мобильная вёрстка (375px) | Горизонтальный переполнение на телефоне: scrollWidth=366 > clientWidth=360 (на 6px). Контент уезжает за экран. | — | MEDIUM |
...
- Всего багов: 4
- 1. **[MEDIUM]** мобильная вёрстка (375px): Горизонтальный переполнение на телефоне: scrollWidth=366 > clientWidth=360 (на 6px). Контент уезжает за экран.
